...
@WebServlet(
        name = "DeleteInchDiary"
)
public class DeleteInchDiary extends HttpServlet {
    private static final String DATE_PATTERN = "yyyy-MM";

    public DeleteInchDiary() {
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            deleteBean.checkExist();
            if (deleteBean.getStatus()) {
                throw new DiaryNotFondException();
            }
            deleteBean.deleteInch();
            deleteBean.checkExist();
            if (!deleteBean.getStatus()) {
